...
taiKhoanKHRouter.post('/register/request-otp', authController.requestRegisterOtp);
taiKhoanKHRouter.post('/register/complete', authController.completeRegistration);
